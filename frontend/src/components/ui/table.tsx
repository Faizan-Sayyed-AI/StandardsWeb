...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn("border-t border-border bg-foreground/4 font-medium [&>tr]:last:border-b-0", className)}
    {...props}
  />
));
  ...
  ({ className, ...props }, ref) => (
    <tr
      ...
      className={cn(
        ...
        "hover:bg-foreground/4 data-[state=selected]:bg-indigo-600/10",
        className
      )}
      {...props}
    />
