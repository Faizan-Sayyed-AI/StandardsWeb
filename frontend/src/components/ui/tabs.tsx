...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-start rounded-lg bg-foreground/5 p-1 text-muted-foreground gap-1",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ...
    className={cn(
      ...
      "focus-visible:ring-ring focus-visible:ring-offset-2 animate-fade-in-up",
      className
    )}
    {...props}
  />
